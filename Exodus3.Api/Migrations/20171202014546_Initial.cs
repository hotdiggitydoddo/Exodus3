        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<int>(type: "int4", nullable: true),
                    SeriesId = table.Column<Guid>(type: "uuid", nullable: true),
                    Description = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: true),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    AudioSrcUrl = table.Column<string>(type: "text", nullable: true),
                    Date = table.Column<DateTimeOffset>(type: "timestamptz", nullable: true),
                    Sermon_Name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    SeasonId = table.Column<Guid>(type: "uuid", nullable: true),
                    Summary = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_E3Entity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_E3Entity_E3Entity_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "E3Entity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_E3Entity_E3Entity_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "E3Entity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_E3Entity_SeriesId_Number",
                table: "E3Entity",
                columns: new[] { "SeriesId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_E3Entity_SeasonId",
                table: "E3Entity",
                column: "SeasonId");
        }
